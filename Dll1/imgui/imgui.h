...
namespace ImGui
{
    ...
    IMGUI_API bool IsActiveHotkey(ImGuiBind_t* key);
    IMGUI_API bool Hotkey(const char* label, ImGuiBind_t* var, const ImVec2& size_arg);
...
struct ImGuiIO
{
    ...
    ImFontAtlas*FontsAdvanced;                          // <auto>           // Font atlas: load, rasterize and pack one or more fonts into a single texture.
