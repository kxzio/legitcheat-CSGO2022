...
namespace util::draw
{
	...
	using position = d_math::vec2f;
	using rect = d_math::vec4f;
	using color = d_math::color_rgba;
	using pack_color = d_math::color_rgba;
	using font_t = size_t; //
	using tex_id = void*;
	using matrix = d_math::matrix4x4f;
	using vec4f = d_math::vec4f;
